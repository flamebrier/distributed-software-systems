package ru.flamebrier.lab05.carshop.dao;

import ru.flamebrier.lab05.carshop.models.Car;
import ru.flamebrier.lab05.carshop.models.Owner;
...
public class DAO {
    ...
    private Connection establishConnection() throws DAOException {
        ...
        try {
            ...
            DataSource ds = (DataSource) ctx.lookup("jdbc/carshop");
            conn = ds.getConnection();
        } catch (SQLException | NamingException ex) {
            throw new DAOException("Can't connect to database" + ex.getMessage());
        }
        return conn;
    }
